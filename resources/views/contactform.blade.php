  ...
  <div class="container">
    ...
    <div class="abc">
      <div class="panel-body">
        <h2><b> <center>@lang('messages.contact_us')</center> </b></h2></div>
    </div>
  </div>
  <br/>
  <br/>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="message" id="message" class="form-control" rows="9" cols="25" required="required" placeholder="@lang('messages.message')"></textarea>
                </div>
              </div>
              <div class="col-md-12">
